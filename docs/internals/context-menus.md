...
| Selected sketch rows, more than one   | `ModelTree.tsx`            | Show / Hide, Group, Delete, each one undo step                                                                                                                    |
...
| Sketch curve or point while sketching | `ViewportContextMenu.tsx`  | Relations that fit the whole selection (CUST-030), then Delete; curves add Toggle construction, then Length and angle for a line or Dimension for a circle or arc |
| Empty viewport, idle or sketching     | `ViewportContextMenu.tsx`  | Relations that fit the selection while sketching, then Fit, the seven named views, Orthographic or Perspective                                                    |
