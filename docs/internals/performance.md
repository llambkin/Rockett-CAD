...
| preview tints compare mesh arrays                                             | 1,000 unchanged bodies: 23 ms per preview evaluation, 0.08 ms by `meshKey`                                          | new row                                                                                                                     | PERF-038           |
...
| static client assets raw and revalidated                                      | JS 1,114,913 bytes, 307,258 gzipped; CSS 14,563, 3,507 gzipped; `max-age=0` on both                                 | new row                                                                                                                     | PERF-040           |
...
| inputs sending a request per keystroke                                        | none found                                                                                                          | not worth: no search boxes exist, renames commit on Enter or blur, dialogs and quick edit dwell 300 ms                      | -                  |
